      ...
      <div class="row g-5">
        <div class="col-md-7 col-lg-8">
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="update_report_title" value={$report[0]["title"]}>
            ...
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="update_report_sei" value={$report[0]["sei"]}>
                <div class="invalid-feedback">
                  名字を入力してください
                </div>
              </div>
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="update_report_mei" value={$report[0]["mei"]}>
                <div class="invalid-feedback">
                  名前を入力してください
                </div>
              </div>
              ...
              <div class="col-12">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="update_category" value="ネットワーク">ネットワーク
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="update_category" value="AWS">AWS
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="update_category" value="コマンドライン">コマンドライン
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="update_category" value="OS">OS
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="update_category" value="ミドルウェア">ミドルウェア
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="update_category" value="エラー対応">エラー対応
                </div>
                <div class="form-check">
              ...
              <div class="col-16">
                <div class="input-group">
                    ...
                    <textarea class="form-control" aria-label="With textarea" id="update_report_content" value={$report[0]["content"]}></textarea>
                </div>
              </div>
              ...
              <div class="col-16">
                <div class="input-group">
                    ...
                    <textarea class="form-control" aria-label="With textarea" id="update_report_url" value={$report[0]["url"]}></textarea>
                </div>
              </div>

              <div class="col-12">
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="update_report_image" value={$report[0]["image_path"]}>
                </div>
              </div>
            </div>
