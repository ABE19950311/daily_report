...
<form method="GET" action="https://192.168.64.6/home/1">
    <div class="input-group">
        @if (isset($titleSearch))
            <input type="text" name="titleSearch" id="title_search" value={{ $titleSearch }}>
        @else
            <input type="text" name="titleSearch" id="title_search" placeholder="タイトルで検索">
        @endif
    </div>

    <div class="input-group">
        <select aria-label="Default select example" id="category_search" name="categorySearch">
            ...
            <tr>
                ...
                <td>
                    <form method="GET" action="https://192.168.64.6/report/show">
                        <button class="show_report_btn btn btn-primary" name="reportid"
